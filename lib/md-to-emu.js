 ...
 */
export async function markdownToEmuClauses(source, idPrefix) {
...
export async function markdownFileToEmuClauses(filePath, idPrefix) {
  const src = fs.readFileSync(filePath, "utf-8");
  return await markdownToEmuClauses(src, idPrefix);
}
